    ...
    <div className="container">
      ...
      <div className={`firt-section  open  ${open && " toggle-side"}   `}>
        ...
        <div
          className="side-element"
          style={
            selectedData === "Teen" ? { backgroundColor: "#6998F5" } : {}
          }
          onClick={() => {
            setI(10);
        ...
        >
          <SensorOccupiedIcon></SensorOccupiedIcon> Teen Crashes
        </div>
        ...
        <div
          className="side-element"
          style={
            selectedData === "Pred" ? { backgroundColor: "#6998F5" } : {}
          }
          onClick={() => {
            setI(11);
        ...
        >
          <SensorOccupiedIcon></SensorOccupiedIcon> Pred Crashes
        </div>
