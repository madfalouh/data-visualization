...
const CityChart_Speed = () => {
  ...
  function addPropertiesToGeojson(originalData, geojson) {
    ...
    geojsonCopy.features.forEach(function (feature) {
      ...
      if (city) {
         console.log(city);
        feature.properties.alcoholInvolved = city.Not_Speeding_Involved || 0;
        feature.properties.notAlcoholInvolved = city.Speeding_Involved  || 0;
      }
    });
...
export default CityChart_Speed;
