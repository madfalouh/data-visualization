...
const CityChart_Drug = () => {
  ...
  function addPropertiesToGeojson(originalData, geojson) {
    ...
    geojsonCopy.features.forEach(function (feature) {
      ...
      feature.properties.alcoholInvolved = city.Drug_Involved || 0;
      feature.properties.notAlcoholInvolved = city.Not_Drug_Involved || 0;
      }
    });
