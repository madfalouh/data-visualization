...
function addPropertiesToTopojson(originalData, topojson) {
  ...
  topojsonCopy.objects.cb_2015_mississippi_county_20m.geometries.forEach(function(feature) {
    ...
    if (county) {
      feature.properties.alcoholInvolved = county.Drug_Involved || 0;
      feature.properties.notAlcoholInvolved = county.Not_Drug_Involved || 0;
    }
  });
...
export default  CountyChart_Drug 