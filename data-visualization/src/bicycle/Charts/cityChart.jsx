...
import dataInj from "../cyclist_all_inj_2020/city";
import Fatal_cities from "../bicycle_fatal_long_list/city";
import dataA_city from "../cyclist_a_inj_2020/city";
import dataAB_city from "../cyclist_ab_inj_2020/city";
...
const CityChart = () => {
  ...
  const geojsonDataALL = addPropertiesToGeojson(dataInj.datasets[0].data, data);
