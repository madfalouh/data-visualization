...
const CityChart_mtrc = () => {
  ...
  function addPropertiesToGeojson(originalData, geojson) {
    ...
    geojsonCopy.features.forEach(function (feature) {
      ...
      if (city) {
         console.log(city);
        feature.properties.alcoholInvolved = city.Motorcycle || 0;
        feature.properties.notAlcoholInvolved = city.Not_Motorcycle  || 0;
      }
    });
